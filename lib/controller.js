module.exports = function(resolve, find, render, YAML, mutate)
{
    ...
    mutate = mutate || function(path, result, config) {
      return result;
    }
    ...
    const makeConfig = function(config = {}, method = 'GET', params = {}) {
        Object.keys(config[method] || {}).forEach(
            function(key) {
                if(params[key] != null) {
    ...
    return function(request, response, next) {
        let config = {};
        find(resolve(request.path)).then(
            function(obj)
            {
                var body;
                try {
                ...
                return render(
                    Object.assign({}, vars, {content: obj.content})
                );
            }
        ).then(
            function(result)
